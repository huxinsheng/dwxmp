...
import cn.dwxmp.core.support.login.ThirdPartyLoginHelper;
import cn.dwxmp.core.support.login.ThirdPartyUser;
...
public class ThirdPartyLoginController extends AbstractController<SysProvider> {
