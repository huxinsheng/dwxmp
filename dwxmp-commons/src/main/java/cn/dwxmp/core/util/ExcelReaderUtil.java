...
import cn.dwxmp.core.support.excel.Excel2003Reader;
import cn.dwxmp.core.support.excel.Excel2007Reader;
import cn.dwxmp.core.support.excel.IRowReader;
...
public final class ExcelReaderUtil {
	...
	public static void readExcel(IRowReader reader, String fileName) throws Exception {
		// 处理excel2003文件
		readExcel(reader,fileName,new FileInputStream(fileName));
	}
	...
	public static void readExcel(IRowReader reader, String fileName, InputStream inputStream) throws Exception {
		...
		if (fileName.endsWith(EXCEL03_EXTENSION)) {
			...
			excel07.processAll(inputStream);
		} else {
