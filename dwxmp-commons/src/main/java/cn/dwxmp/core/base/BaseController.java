...
import cn.dwxmp.core.exception.BaseException;
import cn.dwxmp.core.exception.IllegalParameterException;
import cn.dwxmp.core.support.DateFormat;
...
public abstract class BaseController {
    ...
    public void exceptionHandler(HttpServletRequest request, HttpServletResponse response, Exception ex)
        ...
        if (ex instanceof BaseException) {
            ...
            modelMap.put("msg", msg.length() > 100 ? "系统出现异常,请稍候再试." : msg);
        }
