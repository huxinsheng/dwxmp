...
public class WeiXinCompanySendMsg {
     ...
     * @param toparty 部门ID列表，多个接收者用‘|’分隔，最多支持100个。当touser为@all时忽略本参数s
    ...
    public static String sendTextMsg(String touser, String toparty, String totag, int agentid, String content,
        ...
        jsonObject.put("agentid", String.valueOf(agentid));// 企业应用的id，整型。可在应用的设置页面查看
        ...
        reSend(urlStr, parameters, new HashMap<>());
     ...
     * @return
     */
    public static String sendFileMsg(String touser, String toparty, String totag, int agentid, String mediaId,
                                     boolean safe) throws IOException {
        JSONObject jsonObject = new JSONObject();
