 ...
 * 
 */
package cn.dwxmp.core.support.scheduler.job;

import cn.dwxmp.core.base.BaseProvider;
import cn.dwxmp.core.base.Parameter;
import cn.dwxmp.core.support.scheduler.TaskScheduled.TaskType;
import cn.dwxmp.core.util.DubboUtil;
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			...
			if (TaskType.local.equals(taskType)) {
				...
				String system = "org.dwxmp.provider.I" + jobDataMap.getString("targetSystem");
